  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-primary-50 border border-primary-100" data-tour="calendar">
          <CardBody>
        ...
        <Card className="bg-success-50 border border-success-100" data-tour="payments">
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold text-success-900">$10,000</h3>
              </div>
            </div>
          </CardBody>
        </Card>
